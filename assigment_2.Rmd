...
# Distribution of votes grouped by income
ggplot(df, aes(x=vote,  group=income)) + 
    geom_bar(aes(y = ..prop.., fill = factor(..x..,labels=levels(df$vote))), stat="count") +
...
# Distribution of AfD votes by gender grouped by income
...
# Distribution of immigration opinion grouped by political parties
...
#  Distribution of AfD votes by income grouped by immigration opinion
...
#  Distribution of Gruene votes by income grouped by gender
