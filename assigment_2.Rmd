...
df$egoposition_immigration_red <- as.factor(
  ifelse(df$egoposition_immigration == "immgration.0", 'immgration.open',
  ifelse(df$egoposition_immigration == "immgration.1", 'immgration.open',
  ifelse(df$egoposition_immigration == "immgration.2", 'immgration.open',
  ifelse(df$egoposition_immigration == "immgration.10", 'immgration.restrictive',
  ifelse(df$egoposition_immigration == "immgration.9", 'immgration.restrictive',
  ifelse(df$egoposition_immigration == "immgration.8", 'immgration.restrictive',
  ifelse(df$egoposition_immigration == "immgration.7", 'immgration.restrictive',
  ifelse(df$egoposition_immigration == "immgration.6", 'immgration.restrictive',
         'immgration.mid')))))))))
...
pie(table(df$vote),labSels = names(table(df$vote)), col=rainbow(length(table(df$vote))), main="Distribution of votes (Target variable)")
...
#(?) no saco muchas conslusiones, igual hay que hacer los plots porcentualmente porque estan muy desvanalnceados.

#(?) egoposition_immigration es una mierda para trabajar. Igual se podria cambiar a categorias mas pequeñas.
