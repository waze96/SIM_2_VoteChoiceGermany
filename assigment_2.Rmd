...
load("~/GitHub/SIM_2_VoteChoiceGermany/gles.RData")
...
# egoposition_immigration_red x political orientation
...
```{r include=FALSE}
df
mca_df <-MCA(df[,c(11,9,3,4,5,6)], ncp = 5, graph = TRUE)
